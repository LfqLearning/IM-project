package com.qubar.recommend.msg;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.qubar.dubbo.server.pojo.Publish;
import com.qubar.recommend.pojo.RecommendQuanZi;
...
@Component
@RocketMQMessageListener(topic = "qubar-quanzi", consumerGroup = "qubar-quanzi-consumer")
public class QuanZiMsgConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String msg) {
        try {
            ...
            long data = jsonNode.get("data").asLong();
