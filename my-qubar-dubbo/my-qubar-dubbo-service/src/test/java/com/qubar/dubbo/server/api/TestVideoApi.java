...
public class TestVideoApi {
    ...
    //@Autowired
    private final VideoApi videoApi = new VideoApiImpl();
    ...
    public void testSaveVideo() {
        for (int i = 0; i < 100; i++) {
            ...
            video.setLocationName("北京市");
            video.setSeeType(1);
            video.setPicUrl("http://itcast-tanhua.oss-cn-shanghai.aliyuncs.com/images/2019/10/07/15704367549907417.png");
            video.setVideoUrl("http://192.168.31.81:8888/group1/M00/00/02/wKgfUV2a9pmAQgIlACYJuhDRF3g362.mp4");
    ...
    public void testSaveRecommend() {
        for (int i = 0; i < 1000; i++) {
            ...
            this.mongoTemplate.save(recommendQuanZi, "recommend_video_20230216");
        }
    }
